...
def resize_mesh(quality: float,
    ...
    main["data"]["matrix"][0][1] = str(concrete_0) + str(";") + str(qual) + str(";") + str(quality)
    main["data"]["matrix"][0][2] = str(11.5 - concrete_0) + str(";") + str(qual) + str(";") + str(quality)
    main["data"]["matrix"][0][3] = str(11.5) + str(";") + str(qual) + str(";") + str(quality)

    main["data"]["matrix"][1][0] = str(0)
    main["data"]["matrix"][1][1] = str(concrete_0) + str(";") + str(qual) + str(";") + str(quality)
    main["data"]["matrix"][1][2] = str(22 - concrete_0) + str(";") + str(qual) + str(";") + str(quality)
    main["data"]["matrix"][1][3] = str(22) + str(";") + str(qual) + str(";") + str(quality)

    main["data"]["matrix"][2][0] = str(0)
    main["data"]["matrix"][2][1] = str(concrete_0) + str(";") + str(qual) + str(";") + str(quality)
    main["data"]["matrix"][2][2] = str(concrete_0 + rw_size) + str(";") + str(qual) + str(";") + str(quality)
    main["data"]["matrix"][2][3] = str(9 - concrete_0) + str(";") + str(qual) + str(";") + str(quality)
    main["data"]["matrix"][2][4] = str(9) + str(";") + str(qual) + str(";") + str(quality)

    with open('single_rw.yaml', 'w') as outfile:
