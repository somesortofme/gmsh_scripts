...
def resize_trunch(tranch_length: float,
    ...
    with open('RW_box.yaml') as f4:
        RW_box = yaml.full_load(f4)
    with open('RW_line.yaml') as f5:
        RW_line = yaml.full_load(f5)
    ...
    bent_box_low["data"]["matrix"][1][1] = str(1.8) + str(";") + str(quality)
    ...
    RW["data"]["matrix"][0][1] = str(11.85) + str(";") + str(quality)

    RW["data"]["matrix"][1][0] = str(0) + str(";") + str(quality)
    RW["data"]["matrix"][1][1] = str(5.5) + str(";") + str(quality)

    RW["data"]["matrix"][2][0] = str(0) + str(";") + str(quality)
    RW["data"]["matrix"][2][1] = str(tranch_length) + str(";") + str(quality)

    #workaround RW_line
    RW_line["data"]["matrix"][0][0] = str(0) + str(";") + str(quality)
    RW_line["data"]["matrix"][0][1] = str(10.15) + str(";") + str(quality)

    RW_line["data"]["matrix"][1][0] = str(0) + str(";") + str(quality)
    RW_line["data"]["matrix"][1][1] = str(1.375) + str(";") + str(quality)

    RW_line["data"]["matrix"][2][0] = str(0) + str(";") + str(quality)
    RW_line["data"]["matrix"][2][1] = str(tranch_length) + str(";") + str(quality)

    #workaround RW_box

    RW_box["data"]["matrix"][0][0] = str(0) + str(";") + str(quality)
    RW_box["data"]["matrix"][0][1] = str(1.65) + str(";") + str(quality)

    RW_box["data"]["matrix"][1][0] = str(0) + str(";") + str(quality)
    RW_box["data"]["matrix"][1][1] = str(1.375) + str(";") + str(quality)

    RW_box["data"]["matrix"][2][0] = str(0) + str(";") + str(quality)
    RW_box["data"]["matrix"][2][1] = str(tranch_length) + str(";") + str(quality)
    ...
    bent_side["data"]["matrix"][0][1] = str(0.45) + str(";") + str(quality)
    ...
    with open('RW_box.yaml', 'w') as outfile:
        yaml.dump(RW_box, outfile)
    with open('RW_line.yaml', 'w') as outfile:
        yaml.dump(RW_line, outfile)
