...
def resize_mesh(env_0: float,
    ...
    with open('another_small_building.yaml') as f7:
        a_small_b = yaml.full_load(f7)
    with open('another_concrete_1_small.yaml') as f8:
        a_c_1_s = yaml.full_load(f8)
    with open('another_RW+Sand.yaml') as f9:
        a_RW = yaml.full_load(f9)
    ...
    #Workaround different RW
    a_RW["data"]["matrix"][0][0] = str(0) + str(";") + str(quality)
    a_RW["data"]["matrix"][0][1] = str(9.5) + str(";") + str(quality)  # str(20) + str(";") + str(quality)

    a_RW["data"]["matrix"][1][0] = str(0) + str(";") + str(quality)
    a_RW["data"]["matrix"][1][1] = str(20) + str(";") + str(quality)  # str(9.5) + str(";") + str(quality)

    a_RW["data"]["matrix"][2][0] = str(0) + str(";") + str(quality)
    a_RW["data"]["matrix"][2][1] = str(2.6) + str(";") + str(quality)
    a_RW["data"]["matrix"][2][2] = str(7) + str(";") + str(quality)
    ...
    #Workaround different container
    a_c_1_s["data"]["matrix"][0][0] = str(0) + str(";") + str(quality)
    a_c_1_s["data"]["matrix"][0][1] = str(9.5 + concrete_0 * 2) + str(";") + str(
        quality)  # str(20 + concrete_0 * 2) + str(";") + str(quality)

    a_c_1_s["data"]["matrix"][1][0] = str(0) + str(";") + str(quality)
    a_c_1_s["data"]["matrix"][1][1] = str(20 + concrete_0 * 2) + str(";") + str(
        quality)  # str(9.5 + concrete_0 * 2) + str(";") + str(quality)

    a_c_1_s["data"]["matrix"][2][0] = str(0) + str(";") + str(quality)
    a_c_1_s["data"]["matrix"][2][1] = str(7 + concrete_0 * 2) + str(";") + str(quality)

    a_c_1_s["data"]["children_transforms"][0][0][0] = concrete_0
    a_c_1_s["data"]["children_transforms"][0][0][1] = concrete_0
    a_c_1_s["data"]["children_transforms"][0][0][2] = concrete_0
    ...
    #Workaround another small building
    a_small_b["data"]["children_transforms"][1][0][0] = 9.5 + concrete_0 * 2
    a_small_b["data"]["children_transforms"][2][0][0] = (9.5 + concrete_0 * 2) * 2
    a_small_b["data"]["children_transforms"][3][0][1] = 20 + concrete_0 * 2
    a_small_b["data"]["children_transforms"][4][0][0] = 9.5 + concrete_0 * 2
    a_small_b["data"]["children_transforms"][4][0][1] = 20 + concrete_0 * 2
    a_small_b["data"]["children_transforms"][5][0][0] = (9.5 + concrete_0 * 2) * 2
    a_small_b["data"]["children_transforms"][5][0][1] = 20 + concrete_0 * 2
    ...
    # #workaround floor
    # workaround floor
    e_b["data"]["points"][0][0] = round(l1 - (concrete_1 * math.cos(45)),
                                        2)  # TODO check if it moves corrdctly with concrete_1
    ...
    e_b["data"]["points"][4][2] = round(env_1_Z - (concrete_1 * math.sin(45)), 2)#env_1_Z - concrete_1  # round(env_1_Z - (concrete_1 * math.sin(45)), 2)
    ...
    e_b["data"]["points"][5][2] = round(env_1_Z - (concrete_1 * math.sin(45)), 2)#env_1_Z - concrete_1  # round(env_1_Z - (concrete_1 * math.sin(45)), 2)
    ...
    e_b["data"]["points"][6][2] = round(env_1_Z - (concrete_1 * math.sin(45)), 2)#env_1_Z - concrete_1  # round(env_1_Z - (concrete_1 * math.sin(45)), 2)
    ...
    e_b["data"]["points"][7][2] = round(env_1_Z - (concrete_1 * math.sin(45)), 2)#env_1_Z - concrete_1  # round(env_1_Z - (concrete_1 * math.sin(45)), 2)
    e_b["data"]["points"][7][3] = quality
    # e_b["data"]["points"][0][0] = l1 - concrete_1 * 2 #TODO check if it moves corrdctly with concrete_1
    # e_b["data"]["points"][0][1] = h2 - concrete_1 * 2
    # e_b["data"]["points"][0][2] = 0
    # e_b["data"]["points"][0][3] = quality
    #
    # e_b["data"]["points"][1][0] = concrete_1
    # e_b["data"]["points"][1][1] = h2 - concrete_1 * 2
    # e_b["data"]["points"][1][2] = 0
    # e_b["data"]["points"][1][3] = quality
    #
    # e_b["data"]["points"][2][0] = m + concrete_1
    # e_b["data"]["points"][2][1] = concrete_1
    # e_b["data"]["points"][2][2] = 0
    # e_b["data"]["points"][2][3] = quality
    #
    # e_b["data"]["points"][3][0] = m + l2 - concrete_1 * 2
    # e_b["data"]["points"][3][1] = concrete_1
    # e_b["data"]["points"][3][2] = 0
    # e_b["data"]["points"][3][3] = quality
    #
    # #Workaroun roof
    # e_b["data"]["points"][4][0] = k + l3 - concrete_1
    # e_b["data"]["points"][4][1] = n + h1 - concrete_1
    # e_b["data"]["points"][4][2] = env_1_Z - concrete_1
    # e_b["data"]["points"][4][3] = quality
    #
    # e_b["data"]["points"][5][0] = k + concrete_1
    # e_b["data"]["points"][5][1] = n + h1 - concrete_1
    # e_b["data"]["points"][5][2] = env_1_Z - concrete_1
    # e_b["data"]["points"][5][3] = quality
    #
    # e_b["data"]["points"][6][0] = v + concrete_1
    # e_b["data"]["points"][6][1] = n #+ concrete_1
    # e_b["data"]["points"][6][2] = env_1_Z - concrete_1
    # e_b["data"]["points"][6][3] = quality
    #
    # e_b["data"]["points"][7][0] = v + l4 - concrete_1
    # e_b["data"]["points"][7][1] = n #+ concrete_1
    # e_b["data"]["points"][7][2] = env_1_Z - concrete_1
    # e_b["data"]["points"][7][3] = quality

    #size of buildings in y = (20+concrete_0*2)*4 + 27
    #Workaround small building
    buildings_size = (20 + concrete_0 * 2) * 4 + 27
    hill_size = h2 - concrete_1 * 2
    #print((hill_size - buildings_size) / 2)
    e_b["data"]["children_transforms"][0][0][0] = l_small#X
    e_b["data"]["children_transforms"][0][0][1] = (abs(hill_size - buildings_size) / 2) + concrete_0#abs((h2 - concrete_1 * 2) - ((20 + concrete_0 * 2) * 4 + 27)) / 2# middle of h2

    #Workaround long building
    e_b["data"]["children_transforms"][1][0][0] = abs(l1 - (9.5 + concrete_0 * 2) * 7) / 2#X
    e_b["data"]["children_transforms"][1][0][1] = (((abs(hill_size - buildings_size) / 2) + concrete_0) + ((20 + concrete_0 * 2) * 2) + 27) #+ (20 + concrete_0 * 2)#(abs((h2 - concrete_1 * 2) - ((20 + concrete_0 * 2) * 4) + 27) / 2) + 27 + (20 + concrete_0 * 2)
    ...
    # c_u["data"]["points"][7][2] = env_1_Z #+ concrete_1
    # c_u["data"]["points"][7][3] = quality
    # c_u["data"]["children_transforms"][0][0][0] = concrete_1 / 2#60 + (9.5 + concrete_0 * 2) * 2
    # c_u["data"]["children_transforms"][0][0][1] = concrete_1 / 2
    ...
    result["data"]["children_transforms"][0][0][0] = abs(env_0_XY - l1) / 2
    result["data"]["children_transforms"][0][0][1] = abs(env_0_XY - h2) / 2
    ...
    with open('another_small_building.yaml', 'w') as outfile:
        yaml.dump(a_small_b, outfile)
    with open('another_concrete_1_small.yaml', 'w') as outfile:
        yaml.dump(a_c_1_s, outfile)
    with open('another_RW+Sand.yaml', 'w') as outfile:
        yaml.dump(a_RW, outfile)
